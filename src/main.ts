...
<span class="py-kw">class</span> <span class="py-class">QuickstartUser</span>(HttpUser):
    <span class="py-dec">@task</span>
    <span class="py-kw">def</span> <span class="py-fn">browse</span>(<span class="py-self">self</span>):
        <span class="py-self">self</span>.client.<span class="py-fn">get</span>(<span class="py-str">&quot;/hello&quot;</span>)
        <span class="py-self">self</span>.client.<span class="py-fn">get</span>(<span class="py-str">&quot;/world&quot;</span>)
        <span class="py-kw">for</span> item_id <span class="py-kw">in</span> <span class="py-fn">range</span>(<span class="py-num">10</span>):
            <span class="py-self">self</span>.client.<span class="py-fn">get</span>(<span class="py-str">f&quot;/item?id=<span class="py-interp">{item_id}</span>&quot;</span>, name<span class="py-op">=</span><span class="py-str">&quot;/item&quot;</span>)
...
<section id="next-steps">
  <div id="docs">
    ...
    <ul>
      <li>
        <a href="https://docs.locust.io/en/stable/">
          <img class="logo" src="${readthedocsLogo}" alt="" />
          Documentation
        </a>
      </li>
...
<img src="https://static.pepy.tech/personalized-badge/locust?period=monthly&left_color=GRAY&right_color=BLUE" alt="PyPI Downloads">
<div class="ticks"></div>
